    ...
    return (
        <div>
            <div className="grid grid-cols-2 h-screen">
                    ...
                    <section class="bg-white dark:bg-gray-900">
                        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                            <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                                <h2 class="mb-4 text-4xl tracking-tight font-bold text-gray-900 dark:text-white">{props.title}</h2>
                                <p>time limit per test: {props.time_limit} seconds</p>
                                ...
                                <p class="font-light">{props.input_format}</p>
                                <br />
                                <p class="font-light"> <b>Output Format</b></p>
                                <p class="font-light">{props.output_format}</p>
                                <br />
                                <p>Examples</p>
                                <br />
                                <div class="flex">
                                    <div class="flex flex-col w-1/2 h-32 p-4 border border-gray-400 rounded-md mr-4">
                                        <div class="flex flex-1 border-b border-gray-400">
                                            <div class="flex-1 p-2">
                                                ...
                                                <p class="text-gray-500">{props.example_input}</p>
                                            </div>
                                    ...
                                    <div class="flex flex-col w-1/2 h-32 p-4 border border-gray-400 rounded-md">
                                        <div class="flex flex-1 border-b border-gray-400">
                                            <div class="flex-1 p-2">
                                                ...
                                                <p class="text-gray-500">{props.example_output}</p>
                                            </div>
                                        </div>
                ...
                <div>
                    {/* <label for="lang" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select your Language</label> */}
                    ...
                    {/* <textarea value={code} onChange={handleCodeChange} className="bg-black text-white w-full h-full">
